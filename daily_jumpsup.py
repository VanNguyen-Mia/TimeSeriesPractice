...
result.plot()
plt.suptitle('Seasonal Decomposition of art-daily-jumpsup')
plt.tight_layout()
plt.show()
...
plt.title('Seasonal Component of art-daily-jumpsup')
plt.xlabel('Day')
...
plt.title('art_daily_jumpsup with and without Seasonal Component')
plt.xlabel('Day')
