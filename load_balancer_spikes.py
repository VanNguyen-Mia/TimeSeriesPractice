...
## READ THE DATA 
df = pd.read_csv('./art_load_balancer_spikes.csv')
...
plt.title('art_load_balancer_spikes')
...
result.plot()
plt.suptitle('Seasonal Decomposition of art_load_balancer_spikes')
plt.tight_layout()
plt.show()
...
plt.title('Seasonal Component of art_load_balancer_spikes')
plt.xlabel('Day')
...
plt.title('art_load_balancer_spikes with and without Seasonal Component')
plt.xlabel('Day')
